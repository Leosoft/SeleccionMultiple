...
public class SeleccionMultiple {
    ...
    public static void main(String[] args){
        ...
        int numero;
        numero = Integer.parseInt(JOptionPane.showInputDialog("Ingrese un numero (1-10)"));
        
        //Se va a utilizar la estructura selectiva multiple 
        switch(numero)
        {
            ...
            default: JOptionPane.showMessageDialog(null, "Numero fuera del rango permitido");
            break;
        }
        
        //Estructura selectiva simple, donde se verifica el rango elegido.
        if(numero >= 5)
            JOptionPane.showMessageDialog(null, "Rango Mayor");
        else
            JOptionPane.showMessageDialog(null, "Rango Menor");
    }
}
